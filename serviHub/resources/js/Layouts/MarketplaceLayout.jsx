                        ...
                        <div className="hidden sm:flex sm:items-center sm:ml-6">
                            {auth.user ? (
                                ...
                                <>
                                    ...
                                    <Link
                                        href={route('register')}
                                        className="ml-4 px-4 py-2 bg-primary text-white text-sm font-medium rounded-md hover:bg-indigo-600 transition duration-150 ease-in-out shadow-sm"
                                    >
                                        Get Started
                                    </Link>
                                </>
                ...
                <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between items-center">
                        <div className="flex items-center">
                             ...
                             <span className="ml-2 text-sm text-gray-500">© {new Date().getFullYear()} ServiHub. All rights reserved.</span>
                        </div>
